...
set "TESTS=tests\integration\test_phase1 tests\integration\test_phase2 tests\integration\test_phase3a tests\integration\test_concurrency tests\bpsec\test_bpsec_primitives tests\session\test_session tests\adapters\test_facade tests\adapters\ion\test_ion_policy tests\adapters\ud3tn\test_aap tests\adapters\ud3tn\test_ud3tn_adapter"
echo.
echo === Building tests ===
for %%t in (%TESTS%) do call :linkbin "%%t.c" "build\%%~nt.exe"

set "EXAMPLES=hello_send sender receiver secure_send secure_link"
echo.
